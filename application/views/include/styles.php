...
.slider-2 {
    padding-top: 7.5rem;
    padding-bottom: 7rem;
    background: url("<?= base_url('assets/'); ?>img/testimonials-background.jpg") center center no-repeat;
...
.form-2 {
    padding-top: 5rem;
    padding-bottom: 6.25rem;
    background: url("<?= base_url('assets/'); ?>img/contact-background.jpg") center center no-repeat;
    background-size: cover;
}
...
a.back-to-top {
    ...
    background: #CBB702 url("<?= base_url('assets/'); ?>img/up-arrow.png") no-repeat center 47%;
...
a.wame {
    ...
    height: 3.5rem;
    border-radius: 1.875rem;
    background: #CBB702 url("<?= base_url('assets/'); ?>img/wa.png") no-repeat center 48%;
